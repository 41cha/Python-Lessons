...
У цьому модулі студенти вивчають **цикли** в Python: `while`, `for`, функцію `range()`, а також команди керування потоком усередині циклів – `break` і `continue`. Ці інструменти дозволяють багаторазово виконувати одну й ту саму дію, поки виконується певна умова або поки є елементи для перебору.
